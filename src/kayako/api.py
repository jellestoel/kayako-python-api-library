...
class KayakoAPI(object):
    ...
    **Quick Reference**
    ...
    def _generate_signature(self):
        ...
        encrypted_signature = hmac.new(self.secret_key, msg=salt.encode('utf-8'), digestmod=hashlib.sha256).digest()
    ...
    def _request(self, controller, method, **parameters):
        ...
        if method == 'GET':
            ...
            parameters['signature'] = b64signature.decode('utf-8')
            data = self._post_data(**self._sanitize_parameters(**parameters)).encode('utf-8')
